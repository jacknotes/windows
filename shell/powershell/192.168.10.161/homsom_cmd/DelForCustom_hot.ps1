...
#删除7天前的文件
$day=$($today.AddDays(-30).ToString('yyyy-MM-dd'))
 
$LocalDir="E:\kingdee-backup"
$FilterDir="E:\kingdee-backup"
...
function delfilelist($RemoteDir=$False)
{
    ...
    {
        Get-ChildItem -Path $RemoteDir -Recurse -ErrorAction SilentlyContinue -Filter AIS20100401100656*.bak |Where-Object { $_.Extension -eq '.bak' }| Where-Object -FilterScript {($_.LastWriteTime -lt $day) -and ($_.PsISContainer -eq $False)} |
